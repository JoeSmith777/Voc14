...
const LUECKENUBUNG_POOL = [{
    ...
    // ===== Serie 3: Possessiv-, Relativpronomen; Vokabeln: viele aus L15-L17 =====
    ...
    },
    {
        ...
        verb: 'Relativpronomen',
        optionen: ['quī', 'quem', 'cuius', 'quō'],
        loesungen: ['quī'],
        erklaerung: 'Der Gesandte, der zum Feldherrn kommt, bringt eine wichtige Nachricht.'
    },
    {
        id: 'lu03_14',
        typ: 'lueckenubung',
        ...
        verb: 'Relativpronomen',
        optionen: ['quibus', 'quōrum', 'quōs', 'quī'],
        loesungen: ['quibus'],
    ...
    },
    {
        ...
        verb: 'Possessivpronomen (Dativ Plural)',
    ...
    },
    {
        id: 'lu03_16',
        typ: 'lueckenubung',
        satz: 'Imperātor ā _____ legātō certior fit.',
        verb: 'Possessivpronomen (Ablativ)',
        optionen: ['suō', 'sui', 'suōs', 'suus'],
        loesungen: ['suō'],
        erklaerung: 'Der Feldherr wird von seinem Gesandten informiert. Nach „ā“ steht der Ablativ; „legātō“ ist Ablativ Singular, daher suō.'
    },
    {
        id: 'lu03_17',
        typ: 'lueckenubung',
        satz: 'Paucīs _____ familiāribus senex fābulam dē bellō narrat.',
        verb: 'Possessivpronomen (Akkusativ)',
        optionen: ['tuōs', 'tuīs', 'tuōrum', 'tuī'],
        loesungen: ['tuōs'],
        erklaerung: 'Der alte Mann erzählt wenigen deiner Freunde eine Geschichte über den Krieg. „familiāribus“ ist Dativ Plural; „deine“ bezieht sich auf „Freunde“ im Akkusativ Plural: tuōs familiārēs.'
    },
    {
        id: 'lu03_18',
        typ: 'lueckenubung',
        satz: 'Arbor prope flūmen _____ magnitūdinem habet.',
        verb: 'Prädikat',
        optionen: ['habet', 'habent', 'habēs', 'habēre'],
        loesungen: ['habet'],
    ...
    },
    {
        id: 'lu03_19',
        typ: 'lueckenubung',
        satz: 'Paucī mīlitēs in mediō locō _____, quod corpus trahere necesse est.',
        verb: 'Prädikat',
        optionen: ['quiēscunt', 'quiēscit', 'quiēscere', 'quiēscēs'],
        loesungen: ['quiēscunt'],
        erklaerung: 'Wenige Soldaten ruhen an einem Ort in der Mitte, weil es nötig ist, den Körper zu ziehen. „Paucī mīlitēs“ steht im Plural; richtig ist quiēscunt.'
    },
    {
        id: 'lu03_20',
        typ: 'lueckenubung',
        ...
        loesungen: ['est'],
        erklaerung: 'Ich habe ein neues Buch über die Kriegskunst. Der Dativ mihi bezeichnet den Besitzer; „liber“ ist das Subjekt im Singular, daher steht est.'
    }
];
